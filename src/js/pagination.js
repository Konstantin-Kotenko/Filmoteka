...
const onPageBtnClick = e => {
  if (e.target.tagName === 'BUTTON') {
    ...
    if (e.target === pageRefs.arrowRightBtn && currentPage < 1000) {
      ...
      pageRefs.showedPageArr.forEach(page => {
    ...
    if (
      ...
      e.target === pageRefs.showedPageArr[0].textContent
    ) {
    ...
    if (e.target === pageRefs.lastPageBtn) {
      pageRefs.showedPageArr[0].hidden = false;
      btns.forEach(btn => btn.classList.remove('pagination__button--current'));
      pageRefs.showedPageArr[0].textContent =
        Number(pageRefs.lastPageBtn.textContent) - 4;
      pageRefs.showedPageArr[1].textContent =
        Number(pageRefs.lastPageBtn.textContent) - 3;
      pageRefs.showedPageArr[2].textContent =
        Number(pageRefs.lastPageBtn.textContent) - 2;
      pageRefs.showedPageArr[3].textContent =
        Number(pageRefs.lastPageBtn.textContent) - 1;
